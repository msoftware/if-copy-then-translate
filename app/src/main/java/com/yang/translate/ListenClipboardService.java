...
import com.yang.translate.clipboard.ClipboardManagerCompat;
import com.yang.translate.api.RetrofitSingleton;
import com.yang.translate.api.TranslateAPI;
...
//        showContent(content);
        RetrofitSingleton.getInstance().translate(content.toString())
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Subscriber<TranslateAPI>() {
            @Override
            ...
            @Override
            public void onNext(TranslateAPI translateAPI) {

                Log.e(TAG, "onNext: "+ translateAPI.toString() );
                if (translateAPI.errorCode == 0){
                    showContent(translateAPI.translation.get(0));
                }
